globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, setCookie, appendHeader, parseCookies, getHeaders, getMethod, getQuery as getQuery$1, createError, isMethod, readBody } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/h3/dist/index.mjs';
import GithubProvider from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/next-auth/providers/github.js';
import { AuthHandler } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/next-auth/core/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/defu/dist/defu.mjs';
import { createRenderer } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/klona/dist/index.mjs';
import { hash } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/radix3/dist/index.mjs';
import getURL from 'file:///Users/justine/projects/me/my-nuxt-app/node_modules/requrl/dist/requrl.js';
...
const serverAssets = [{"baseName":"server","dir":"/Users/justine/projects/me/my-nuxt-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/justine/projects/me/my-nuxt-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/justine/projects/me/my-nuxt-app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/justine/projects/me/my-nuxt-app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/justine/projects/me/my-nuxt-app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _gBEhJ5eh1X = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _qZLEdhwWxb = (function(nitro) {
...
const _lazy_fOMfBD = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_nzUSKD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/auth/**', handler: _lazy_fOMfBD, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_nzUSKD, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nzUSKD, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/justine/projects/me/my-nuxt-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/justine/projects/me/my-nuxt-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
